...
$categoriaController = new categoriaController();
$categorias = $categoriaController->pesquisarCategoria(""); // ou listarTodas()
    ...
    <div class="container py-5">
        ...
        <form action="editar_tarefa.php" method="POST" class="mb-4 bg-white p-4 rounded shadow-sm">
            ...
            <div class="mb-3 d-flex align-items-end">
                <div class="flex-grow-1 me-2">
                    ...
                    <select class="form-select" id="id_categoria" name="tarefa[id_categoria]">
                        ...
                        <?php foreach ($categorias as $cat): ?>
                            <option value="<?= $cat->id_categoria ?>" <?= ($t->id_categoria == $cat->id_categoria) ? 'selected' : '' ?>>
                ...
                <a href="add_categoria.php" class="btn btn-success">Editar Categoria</a>
            </div>
